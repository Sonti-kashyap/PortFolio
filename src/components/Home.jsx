...
function Home() {
  return (
    <>
      <div
        name="Home"
        className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-28 scroll-smooth"
      >
        <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0">
              <div className="  space-y-2">
                ...
                <ul className="flex space-x-5">
                  ...
                  <li>
                    <a href=" https://www.linkedin.com/in/sonti-kashyap-a10472280/" target="_blank">
                      <FaLinkedin className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://wa.me/918826779879" target="_blank">
                      <IoLogoWhatsapp className="text-2xl cursor-pointer" />
                    </a>
                  </li>
                  <li>
                    <a href="https://t.me/+918826779879" target="_blank">
          ...
          <div className="md:w-1/2 md:ml-48 md:mt-1 mt-8 order-1">
            <img
              src={pic}
